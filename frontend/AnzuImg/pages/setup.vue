<template>
  <div class="flex min-h-[calc(100vh-8rem)] items-center justify-center">
    <div class="w-full max-w-md rounded-xl">
      ...
      <p class="mb-6 text-center text-(--md-sys-color-on-surface-variant)">
        {{ t("setup.description") }}
      </p>
...
const { setup, getLastApiErrorDisplay } = useAuth();
...
const handleSetup = async () => {
  ...
  if (success) {
    ...
    notify({
      message: getLastApiErrorDisplay(t("setup.setupFailed")),
